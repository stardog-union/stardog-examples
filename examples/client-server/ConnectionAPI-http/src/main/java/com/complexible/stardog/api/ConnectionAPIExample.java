...
public class ConnectionAPIExample {
	...
	public static void main(String[] args) throws Exception {
		...
		// ----------------------
		// This example assumes you start and run the Stardog server in another process on the local host using the default port.
		String aServerUrl = "http://localhost:5820";

		// Using AdminConnection
		// ---------------------
		// Once the server is running, we want to create a connection to the DBMS itself so we can do
